...
{
  \begin{tabular}{l l}
  \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} & Mutationsklass A, patienten kan randomiseras \\
  \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} & Mutationsklass B, patienten kan randomiseras \\
  & \\
  \includegraphics{./reportgen/assets/rsz_checked_checkbox.png} & Inga mutationer, patienten kan \emph{ej} randomiseras \\
  \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} & Ej utförd/ej bedömbar, patienten kan \emph{ej} randomiseras \\
  \end{tabular}
}
  }%
}
...
{
  \begin{tabular}{l | l}
MSI-H\textsuperscript{1} & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} \\
MSS/MSI-L\textsuperscript{2} & \includegraphics{./reportgen/assets/rsz_checked_checkbox.png} \\
Ej bedömbar & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} \\
  \end{tabular}
}
}}
\end{minipage}
...
\arrayrulecolor{grey}\hline
\textit{BRAF}\textsuperscript{3} & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} & \includegraphics{./reportgen/assets/rsz_checked_checkbox.png} & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} &  \\
\textit{NRAS}\textsuperscript{4} & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} & \includegraphics{./reportgen/assets/rsz_checked_checkbox.png} & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} &  \\
\textit{KRAS}\textsuperscript{4} & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} & \includegraphics{./reportgen/assets/rsz_checked_checkbox.png} & \includegraphics{./reportgen/assets/rsz_unchecked_checkbox.png} &  \\
  \end{tabular}
}
}}
    \end{minipage}%
