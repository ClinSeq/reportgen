...
import json, pdb, subprocess, sys, tempfile
...
"""
    ...
    parser.add_option("--boolFlag", action="store_true", dest="boolFlag",
                      default = False,
                      help = "")
    parser.add_option("--stringSwitch", dest = "stringSwitch",
                      default = "",
                      help = "" + \
                          ". Default=[%default]")
    ...
    (tmp_latex_file, tmp_latex_filename) = tempfile.mkstemp("tmp", "Metadata", options.temp_dir)
